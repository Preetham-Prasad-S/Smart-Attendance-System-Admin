...
import 'package:institute_attendance_system/feature/auth/data/repository/auth_remote_repository_impl.dart';
    ...
    return Scaffold(
      body: Center(
        ...
        children: [
          ...
          ElevatedButton(
              onPressed: () async => await AuthRemoteRepositoryImpl(
